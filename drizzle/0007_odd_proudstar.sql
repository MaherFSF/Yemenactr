...
ALTER TABLE `research_publications` ADD CONSTRAINT `res_pub_org_fk` FOREIGN KEY (`organizationId`) REFERENCES `research_organizations`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
