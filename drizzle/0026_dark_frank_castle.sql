...
ALTER TABLE `partnership_access_requests` ADD CONSTRAINT `par_src_reg_fk` FOREIGN KEY (`sourceRegistryId`) REFERENCES `source_registry`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
