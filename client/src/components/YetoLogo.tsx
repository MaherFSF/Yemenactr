    ...
    return (
      <div 
        className={cn(
          ...
          'bg-gradient-to-br from-[#2e6b4f]/60 to-[#5a7a5a]/60 backdrop-blur-sm',
      ...
      >
        ...
        >
          ...
          <circle cx="50" cy="65" r="2" fill="#2e6b4f" />
  ...
  if (variant === 'icon') {
    return (
      ...
      >
        ...
        {/* Decorative dot */}
        <circle cx="50" cy="70" r="3" fill="#2e6b4f" />
      </svg>
    );
  }
  ...
  return (
    <div className={cn('flex items-center gap-3', className)}>
      ...
      >
        ...
        {/* Dot */}
        <circle cx="25" cy="38" r="2" fill="#2e6b4f" />
      </svg>
      
      <div className="flex flex-col">
        <span className={cn('font-bold text-[#2e6b4f]', textSizes[size])}>
          YETO
        </span>
