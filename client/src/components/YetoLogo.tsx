    ...
    return (
      <div 
        className={cn(
          ...
          'bg-gradient-to-br from-[#2e8b6e]/60 to-[#6b8e6b]/60 backdrop-blur-sm',
      ...
      >
        ...
        >
          ...
          <circle cx="50" cy="65" r="2" fill="#2e8b6e" />
  ...
  if (variant === 'icon') {
    return (
      ...
      >
        ...
        {/* Decorative dot */}
        <circle cx="50" cy="70" r="3" fill="#2e8b6e" />
      </svg>
    );
  }
  ...
  return (
    <div className={cn('flex items-center gap-3', className)}>
      ...
      >
        ...
        {/* Dot */}
        <circle cx="25" cy="38" r="2" fill="#2e8b6e" />
      </svg>
      
      <div className="flex flex-col">
        <span className={cn('font-bold text-[#2e8b6e]', textSizes[size])}>
          YETO
        </span>
