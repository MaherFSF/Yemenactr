          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-6 space-y-4">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                <h3 className="text-lg font-bold text-[#2C3424] flex items-center gap-2">
                  {showTip && <Zap className="w-5 h-5 text-[#C9A961] animate-pulse" />}
                  {title}
                </h3>
              </div>
              <button
            ...
            <div className="flex gap-2 pt-2">
              ...
              {onNext && (
                <button
                  onClick={handleNext}
                  className="flex items-center gap-1 px-4 py-2 text-sm font-bold text-white bg-gradient-to-r from-[#C9A961] to-[#b8964d] hover:from-[#d4af37] hover:to-[#C9A961] rounded-lg transition-all shadow-lg hover:shadow-xl"
                >
                  Next
            ...
            <div className="text-xs text-gray-500 pt-2 border-t border-gray-200">
              💡 Pro tip: You can always access this tour from the menu
            </div>
          </div>
