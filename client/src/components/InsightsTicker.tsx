...
export default function InsightsTicker() {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <Info className="h-4 w-4 text-[#d4a528]" />;
    }
  };
  ...
  return (
    <div 
      className="bg-gradient-to-r from-[#2a3a28] to-[#2e8b6e] text-white py-2 sticky top-0 z-50"
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {source.url && (
                            <a 
                              ...
                              className="text-[#2e8b6e] hover:text-[#2a3a28]"
                            >
