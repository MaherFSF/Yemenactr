...
export default function Trade() {
  ...
  const exportCompositionData = [
    { name: language === "ar" ? "النفط الخام" : "Crude Oil", value: 62, valueUSD: 1302, color: "#4C583E" },
  ...
  const importCompositionData = [
    { name: language === "ar" ? "المواد الغذائية" : "Food Products", value: 32, valueUSD: 2304, color: "#4C583E" },
  ...
  const COLORS = ['#4C583E', '#4C583E', '#C0A030', '#E57373', '#64B5F6', '#9E9E9E'];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="relative h-[400px] overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-[#4C583E]/90 via-[#4C583E]/70 to-transparent" />
        </div>
      ...
      <div className="container py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card className="border-l-4 border-l-[#4C583E]">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-[#4C583E]">$1.1B</div>
          ...
          <Card className="border-l-4 border-l-[#C0A030]">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-[#4C583E]">$16.2B</div>
              <div className="flex items-center gap-1 text-sm text-red-600 mt-2">
          ...
          <Card className="border-l-4 border-l-[#4C583E]">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-[#4C583E]">3</div>
