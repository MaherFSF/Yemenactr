...
export default function Agriculture() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("agriculture");
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="container py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {keyIndicators.map((indicator, index) => (
            <Card key={index} className="border-l-4 border-l-[#2e8b6e]">
          ...
          <TabsContent value="overview">
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Wheat className="h-5 w-5 text-[#2e8b6e]" />
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <MapPin className="h-5 w-5 text-[#2e8b6e]" />
                    ...
                    <tbody>
                      {cropProduction.map((crop, index) => (
                        <tr key={index} className="border-b">
                          ...
                          <td className="p-3 font-semibold text-[#2e8b6e]">
                            {crop.shareEn}
                          </td>
                          <td className="p-3">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  {fisheriesSector.indicators.map((ind, index) => (
                    <div key={index} className="text-center p-4 bg-muted/50 rounded-lg">
                      <div className="text-2xl font-bold text-[#2e8b6e]">{ind.value}</div>
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#65a30d]/20 bg-[#65a30d]/5">
              ...
              {Object.entries(latestValues).slice(0, 6).map(([code, regimes]: [string, any]) => {
                ...
                return (
                  <div key={code} className="p-4 rounded-lg bg-white dark:bg-gray-800 border">
                    ...
                    <div className="text-2xl font-bold" style={{ color: '#65a30d' }}>
      ...
      {/* Sources Used Panel */}
      <SourcesUsedPanel sectorCode="agriculture" />
    </div>
  );
}
