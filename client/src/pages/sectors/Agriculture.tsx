      ...
      <div className="container py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {keyIndicators.map((indicator, index) => (
            <Card key={index} className="border-l-4 border-l-[#2e6b4f]">
          ...
          <TabsContent value="overview">
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Wheat className="h-5 w-5 text-[#2e6b4f]" />
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <MapPin className="h-5 w-5 text-[#2e6b4f]" />
                    ...
                    <tbody>
                      {cropProduction.map((crop, index) => (
                        <tr key={index} className="border-b">
                          ...
                          <td className="p-3 font-semibold text-[#2e6b4f]">
                            {crop.shareEn}
                          </td>
                          <td className="p-3">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  {fisheriesSector.indicators.map((ind, index) => (
                    <div key={index} className="text-center p-4 bg-muted/50 rounded-lg">
                      <div className="text-2xl font-bold text-[#2e6b4f]">{ind.value}</div>
