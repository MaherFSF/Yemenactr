...
export default function Prices() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("prices");
    ...
    <div className="flex flex-col">
      ...
      <div className="container py-8">
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#ef4444]/20 bg-[#ef4444]/5">
