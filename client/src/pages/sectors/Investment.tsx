...
export default function Investment() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("investment");
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-[#2e8b6e] to-[#0B1F33] text-white">
      ...
      <div className="container py-8">
          ...
          <TabsContent value="overview">
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Briefcase className="h-5 w-5 text-[#2e8b6e]" />
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <DollarSign className="h-5 w-5 text-[#2e8b6e]" />
                    ...
                    <div key={index} className="p-4 border rounded-lg">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center">
                          <sector.icon className="h-5 w-5 text-[#2e8b6e]" />
                        </div>
                        <div>
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#14b8a6]/20 bg-[#14b8a6]/5">
      ...
      {/* Sources Used Panel */}
      <SourcesUsedPanel sectorCode="investment" />
    </div>
  );
}
