...
export default function PublicFinance() {
  ...
  const expenditureData = [
    { name: language === "ar" ? "الرواتب" : "Salaries", value: 45, color: "#2e6b4f" },
    { name: language === "ar" ? "الدفاع والأمن" : "Defense & Security", value: 25, color: "#2e6b4f" },
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart data={revenueData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="oil" stackId="a" fill="#2e6b4f" name={language === "ar" ? "النفط" : "Oil"} />
                    <Bar dataKey="customs" stackId="a" fill="#2e6b4f" name={language === "ar" ? "الجمارك" : "Customs"} />
