...
export default function PublicFinance() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("public_finance");
  ...
  const expenditureData = [
    { name: language === "ar" ? "الرواتب" : "Salaries", value: 45, color: "#2e8b6e" },
    { name: language === "ar" ? "الدفاع والأمن" : "Defense & Security", value: 25, color: "#2e8b6e" },
    ...
    <div className="flex flex-col">
      ...
      <div className="container py-8">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart data={revenueData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="oil" stackId="a" fill="#2e8b6e" name={language === "ar" ? "النفط" : "Oil"} />
                    <Bar dataKey="customs" stackId="a" fill="#2e8b6e" name={language === "ar" ? "الجمارك" : "Customs"} />
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#0d9488]/20 bg-[#0d9488]/5">
      ...
      {/* Sources Used Panel */}
      <SourcesUsedPanel sectorCode="public_finance" />
    </div>
  );
}
