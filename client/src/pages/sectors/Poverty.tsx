...
export default function Poverty() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("poverty");
  ...
  const foodSecurityData = [
    { name: language === "ar" ? "المرحلة 1" : "Phase 1", value: 8, color: "#2e8b6e" },
  ...
  // WASH indicators
  const washData = [
    { name: language === "ar" ? "مياه آمنة" : "Safe Water", value: 55, color: "#2e8b6e" },
    { name: language === "ar" ? "صرف صحي" : "Sanitation", value: 42, color: "#C0A030" },
    { name: language === "ar" ? "نظافة" : "Hygiene", value: 38, color: "#2e8b6e" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="container py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-l-4 border-l-[#2e8b6e]">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-[#2e8b6e]">0.448</div>
          ...
          <Card className="border-l-4 border-l-[#2e8b6e]">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-[#2e8b6e]">$2.1B</div>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={hdiData}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Line type="monotone" dataKey="hdi" stroke="#2e8b6e" strokeWidth={3} name={language === "ar" ? "مؤشر التنمية" : "HDI"} />
                      <Line type="monotone" dataKey="health" stroke="#2e8b6e" strokeWidth={2} strokeDasharray="5 5" name={language === "ar" ? "الصحة" : "Health"} />
          ...
          <TabsContent value="education" className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-[#2e8b6e]">73%</div>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-2">
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#a855f7]/20 bg-[#a855f7]/5">
      ...
      {/* Sources Used Panel */}
      <SourcesUsedPanel sectorCode="poverty" />
    </div>
  );
}
