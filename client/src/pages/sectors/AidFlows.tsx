...
export default function AidFlows() {
  ...
  // Top donors
  const topDonors = [
    { donor: language === "ar" ? "الولايات المتحدة" : "United States", amount: 520, color: "#103050" },
    { donor: language === "ar" ? "السعودية" : "Saudi Arabia", amount: 380, color: "#107040" },
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart data={fundingData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="funded" fill="#107040" name={language === "ar" ? "الممول" : "Funded"} />
