...
export default function AidFlows() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("aid_flows");
    ...
    <div className="flex flex-col">
      ...
      <div className="container py-8">
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#3b82f6]/20 bg-[#3b82f6]/5">
