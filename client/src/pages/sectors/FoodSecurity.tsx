...
export default function FoodSecurity() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("food_security");
    ...
    <div className="flex flex-col">
      ...
      <div className="container py-8">
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#16a34a]/20 bg-[#16a34a]/5">
