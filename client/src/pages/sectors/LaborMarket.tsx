...
export default function LaborMarket() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("labor");
    ...
    <div className="min-h-screen bg-gradient-to-b from-[var(--yeto-aloe)] to-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#8b5cf6]/20 bg-[#8b5cf6]/5">
