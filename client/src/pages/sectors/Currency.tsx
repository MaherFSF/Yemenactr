...
export default function Currency() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("currency");
    ...
    <div className="flex flex-col">
      ...
      <div className="container py-8">
              ...
              <div className="flex-1">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                  <div className="p-3 bg-white dark:bg-gray-800 rounded-lg border">
                    ...
                    <div className="text-lg font-bold text-[#2e8b6e]">1,650 YER/$</div>
                  ...
                  <div className="p-3 bg-white dark:bg-gray-800 rounded-lg border">
                    ...
                    <div className="text-lg font-bold text-[#2e8b6e]">1,680 YER/$</div>
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#0ea5e9]/20 bg-[#0ea5e9]/5">
            ...
            <Card className="p-4">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#2e8b6e]">2,320</p>
                </div>
                <Sparkline 
            ...
            <Card className="p-4">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#2e8b6e]">562</p>
                </div>
                <Sparkline 
