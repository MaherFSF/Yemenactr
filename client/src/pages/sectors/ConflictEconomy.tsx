...
export default function ConflictEconomy() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("conflict");
    ...
    <div className="flex flex-col">
      ...
      <div className="container py-8">
          ...
          <TabsContent value="overview">
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Landmark className="h-5 w-5 text-[#2e8b6e]" />
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Scale className="h-5 w-5 text-[#2e8b6e]" />
              ...
              {economicImpacts.map((impact, index) => (
                <Card key={index}>
                  <CardContent className="pt-6 text-center">
                    <div className="text-3xl font-bold text-[#2e8b6e] mb-2">
                      {impact.valueEn}
                    </div>
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#dc2626]/20 bg-[#dc2626]/5">
