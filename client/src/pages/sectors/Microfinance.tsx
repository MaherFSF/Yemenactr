...
export default function Microfinance() {
  ...
  const { indicators: liveIndicators, latestValues, isLoading: liveLoading } = useSectorData("microfinance");
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white" dir="rtl">
      ...
      <div className="container py-8">
        ...
        {Object.keys(latestValues).length > 0 && (
          <div className="mb-8 p-6 rounded-xl border border-[#f97316]/20 bg-[#f97316]/5">
