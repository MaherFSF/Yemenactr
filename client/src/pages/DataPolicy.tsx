...
إذا اكتشفت ثغرة أمنية، يرجى الإبلاغ عنها إلى security@yeto.org. نحن نعمل ببرنامج إفصاح مسؤول وسنقر باستلام تقريرك خلال 48 ساعة.`
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950" dir={isArabic ? "rtl" : "ltr"}>
      {/* Header */}
      <div className="bg-gradient-to-br from-[#2e8b6e] to-[#0a5030] text-white py-16">
      ...
      <div className="container max-w-5xl py-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {sections.map((section) => (
                ...
                >
                  <section.icon className="h-4 w-4 text-[#2e8b6e]" />
            ...
            <Card key={section.id} id={section.id} className="scroll-mt-24">
              <CardHeader className="border-b">
                <div className="flex items-center gap-3">
                  <div className="bg-[#2e8b6e]/10 p-2 rounded-lg">
                    <section.icon className="h-5 w-5 text-[#2e8b6e]" />
                  </div>
                  <CardTitle>
                    {isArabic ? section.titleAr : section.titleEn}
                  </CardTitle>
        ...
        {/* Contact Section */}
        <Card className="mt-8 bg-gradient-to-br from-[#2e8b6e]/5 to-[#2e8b6e]/10 border-[#2e8b6e]/20">
          <CardContent className="py-8">
            <div className="text-center">
              <Mail className="h-10 w-10 text-[#2e8b6e] mx-auto mb-4" />
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e8b6e] text-white rounded-lg hover:bg-[#0a5030] transition-colors"
                >
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-[#2e8b6e] text-[#2e8b6e] rounded-lg hover:bg-[#2e8b6e]/10 transition-colors"
                >
