          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <div className="text-2xl font-bold text-[#2e8b6e] dark:text-white">{stat.value}</div>
                ...
                <div className="flex gap-2">
                  {[
                    ...
                    <Button
                      ...
                      className={selectedType === filter.value ? "bg-[#C0A030] text-[#2e8b6e]" : ""}
                    >
                      {filter.label}
                    </Button>
                  ))}
      ...
      <section className="py-16 bg-[#2e8b6e] text-white">
        <div className="container text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact">
              <Button size="lg" className="bg-[#C0A030] hover:bg-[#a08020] text-[#2e8b6e]">
