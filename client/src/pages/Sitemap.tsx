  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      <div className="container py-12">
                  ...
                  {section.links.map((link) => {
                    ...
                    return (
                      <Link
                        key={link.href}
                        href={link.href}
                        className="flex items-center gap-3 p-3 rounded-lg border border-transparent hover:border-[#2e8b6e]/30 hover:bg-[#2e8b6e]/5 transition-all group"
                      >
                        <div className="p-2 rounded-md bg-gray-100 dark:bg-gray-800 group-hover:bg-[#2e8b6e]/10 transition-colors">
                          <Icon className="h-4 w-4 text-gray-600 dark:text-gray-400 group-hover:text-[#2e8b6e]" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-medium truncate group-hover:text-[#2e8b6e]">
        ...
        {/* Quick Stats */}
        <div className="mt-12 p-6 bg-[#2e8b6e] text-white rounded-xl">
