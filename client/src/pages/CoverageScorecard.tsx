...
export default function CoverageScorecard() {
  ...
  const sectorCoverage = [
    ...
    {
      sector: "Poverty & Development",
      sectorAr: "الفقر والتنمية",
      coverage: 58,
      indicators: 25,
      gaps: 12,
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-[#2e8b6e]/10 rounded-lg">
                  <Target className="h-6 w-6 text-[#2e8b6e]" />
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">
                    {language === "ar" ? "التغطية الإجمالية" : "Overall Coverage"}
                  </p>
                  <p className="text-2xl font-bold text-[#2e8b6e]">{overallCoverage}%</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#2e8b6e]">{totalIndicators}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#2e8b6e]">{totalGaps}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#2e8b6e]">{openTickets}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <Dialog open={isNewGapDialogOpen} onOpenChange={setIsNewGapDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-[#2e8b6e] hover:bg-[#0D5A34]">
                ...
                <DialogContent className="max-w-lg">
                  ...
                  <DialogFooter>
                    ...
                    <Button className="bg-[#2e8b6e] hover:bg-[#0D5A34]" onClick={handleSubmitGap}>
