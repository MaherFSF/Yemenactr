...
export default function CoverageScorecard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#768064] to-[#1a4a70] text-white">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#768064]">{overallCoverage}%</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#768064]">{totalIndicators}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#768064]">{totalGaps}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#768064]">{openTickets}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <Dialog open={isNewGapDialogOpen} onOpenChange={setIsNewGapDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-[#4C583E] hover:bg-[#2C3424]">
                ...
                <DialogContent className="max-w-lg">
                  ...
                  <DialogFooter>
                    ...
                    <Button className="bg-[#4C583E] hover:bg-[#2C3424]" onClick={handleSubmitGap}>
