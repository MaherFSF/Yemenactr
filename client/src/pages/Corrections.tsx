            ...
            <Dialog open={reportDialogOpen} onOpenChange={setReportDialogOpen}>
              ...
              <DialogContent className="max-w-lg">
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleSubmitReport} className="bg-[#4C583E] hover:bg-[#0D5A34]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-3xl font-bold text-[#4C583E] dark:text-white">{corrections.length}</div>
            ...
            return (
              <Card key={correction.id} className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-lg text-[#4C583E] dark:text-white mb-2">
          ...
          <Card className="bg-[#4C583E]/5 border-[#4C583E]/20">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <AlertCircle className="h-6 w-6 text-[#4C583E] mt-1" />
                <div>
                  <h3 className="font-semibold text-[#4C583E] dark:text-white mb-2">
