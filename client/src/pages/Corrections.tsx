            ...
            <Dialog open={reportDialogOpen} onOpenChange={setReportDialogOpen}>
              ...
              <DialogContent className="max-w-lg">
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleSubmitReport} className="bg-[#2e6b4f] hover:bg-[#0D5A34]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-3xl font-bold text-[#2e6b4f] dark:text-white">{corrections.length}</div>
            ...
            return (
              <Card key={correction.id} className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-lg text-[#2e6b4f] dark:text-white mb-2">
          ...
          <Card className="bg-[#2e6b4f]/5 border-[#2e6b4f]/20">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <AlertCircle className="h-6 w-6 text-[#2e6b4f] mt-1" />
                <div>
                  <h3 className="font-semibold text-[#2e6b4f] dark:text-white mb-2">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Button variant="outline" className="text-[#2e6b4f] border-[#2e6b4f]/30 hover:bg-[#2e6b4f]/10">
