                    ...
                    <CardContent className="p-6">
                      <div className={`flex items-start gap-4 ${language === 'ar' ? 'flex-row-reverse' : ''}`}>
                        ...
                        <div className="flex-1">
                          ...
                          <h3 className={`font-semibold text-lg text-[#768064] dark:text-white mb-2 ${language === 'ar' ? 'text-right' : ''}`}>
                            ...
                            <div className="flex gap-2">
                              {pub.status === "published" ? (
                                <>
                                  ...
                                  <Button size="sm" className="bg-[#4C583E] hover:bg-[#2C3424]">
      ...
      <div className="bg-white dark:bg-gray-900 border-t py-12">
        <div className="container">
          <Card className="bg-[#768064]/5 border-[#768064]/20">
            <CardContent className="p-6">
              <div className={`flex items-start gap-4 ${language === 'ar' ? 'flex-row-reverse' : ''}`}>
                <Sparkles className="h-6 w-6 text-[#C9A227] mt-1" />
                <div>
                  <h3 className={`font-semibold text-[#768064] dark:text-white mb-2 ${language === 'ar' ? 'text-right' : ''}`}>
