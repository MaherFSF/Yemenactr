                    ...
                    <CardContent className="p-6">
                      <div className={`flex items-start gap-4 ${language === 'ar' ? 'flex-row-reverse' : ''}`}>
                        ...
                        <div className="flex-1">
                          ...
                          <h3 className={`font-semibold text-lg text-[#103050] dark:text-white mb-2 ${language === 'ar' ? 'text-right' : ''}`}>
                              ...
                              <ul className={`space-y-1 text-sm text-gray-600 dark:text-gray-400 ${language === 'ar' ? 'text-right' : ''}`}>
                                {pub.highlights.map((highlight, index) => (
                                  <li key={index} className="flex items-center gap-2">
                                    <TrendingUp className="h-3 w-3 text-[#107040] flex-shrink-0" />
                            ...
                            <div className="flex gap-2">
                              {pub.status === "published" ? (
                                <>
                                  ...
                                  <Button size="sm" className="bg-[#107040] hover:bg-[#0D5A34]">
          ...
          <Card className="bg-[#103050]/5 border-[#103050]/20">
            <CardContent className="p-6">
              <div className={`flex items-start gap-4 ${language === 'ar' ? 'flex-row-reverse' : ''}`}>
                ...
                <div>
                  <h3 className={`font-semibold text-[#103050] dark:text-white mb-2 ${language === 'ar' ? 'text-right' : ''}`}>
