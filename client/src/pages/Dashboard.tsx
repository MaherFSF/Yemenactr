...
export default function Dashboard() {
  ...
  const MiniSparkline = ({ data, color = "#4C583E" }: { data: number[], color?: string }) => {
      ...
      <div className="bg-white dark:bg-gray-900 border-b">
        <div className="container py-6">
          <div className={`${language === 'ar' ? 'text-right' : ''}`}>
            <h1 className="text-2xl md:text-3xl font-bold text-[#768064] dark:text-white mb-2">
                  ...
                  <div key={index} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-[#768064] dark:text-white">{stat.value}</span>
                      </div>
              ...
              <CardContent className="space-y-3">
                {watchlist.map((item, index) => (
                  <div key={index} className="flex items-center justify-between py-2 border-b last:border-0">
                    ...
                    <span className="font-medium text-[#768064] dark:text-white">{item.value}</span>
                  </div>
                ))}
              </CardContent>
            </Card>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-0.5 bg-[#4C583E]"></div>
                      <span className="text-gray-600">{language === "ar" ? "نظام عدن" : "Aden Regime"}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-0.5 bg-[#768064] border-dashed border-t-2 border-[#768064]"></div>
                      <span className="text-gray-600">{language === "ar" ? "نظام صنعاء" : "Sana'a Regime"}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 bg-[#4C583E]/20 rounded"></div>
                    ...
                    <ComposedChart data={gdpData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                      ...
                      {(regimeTag === "both" || regimeTag === "aden") && (
                        <Line 
                          ...
                          stroke="#4C583E" 
                          strokeWidth={2}
                          dot={{ fill: "#4C583E", strokeWidth: 2, r: 4 }}
                          activeDot={{ r: 6, fill: "#4C583E" }}
                      ...
                      {(regimeTag === "both" || regimeTag === "sanaa") && (
                        <Line 
                          ...
                          strokeWidth={2}
                          strokeDasharray="5 5"
                          dot={{ fill: "#768064", strokeWidth: 2, r: 4 }}
                          activeDot={{ r: 6, fill: "#768064" }}
          ...
          <div className={`space-y-6 ${language === 'ar' ? 'lg:order-1' : ''}`}>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <Link href="/sectors">
                  <Button variant="link" className="text-[#4C583E] w-full justify-start">
            ...
            {/* Help Card */}
            <Card className="bg-[#768064] text-white">
              <CardContent className="pt-6">
                <Info className="h-8 w-8 mb-3 text-[#C9A227]" />
                ...
                <Link href="/ai-assistant">
                  <Button size="sm" className="bg-[#4C583E] hover:bg-[#2C3424] text-white w-full">
