/**
 * Insert 2025 Reports Script (v2 - without id, let DB auto-increment)
 * Run with: node scripts/insert-2025-reports-v2.mjs
 */
  ...
  for (let month = 1; month <= 12; month++) {
    ...
    try {
      await connection.execute(
        `INSERT INTO research_publications (title, titleAr, abstract, abstractAr, publicationYear, language, createdAt, updatedAt) 
         VALUES (?, ?, ?, ?, ?, ?, NOW(), NOW())`,
        [
